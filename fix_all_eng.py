...
def save_to_notion(papers, analyzed_results):
    ...
    try:
        ...
        page_kor = notion.pages.create(
            ...
            properties={{"title": [{{"text": {{"content": f"Top {CAP_FIELD} Journals Weekly Report ({{today_str}})"}}}}]}}
        )
        
        # 2. ENG Page
        page_eng = notion.pages.create(
            parent={{"page_id": NOTION_PAGE_ID}},
            properties={{"title": [{{"text": {{"content": f"[ENG] Top {CAP_FIELD} Journals Weekly Report ({{today_str}})"}}}}]}}
        )
...
mapping = [
    ("marketing", "NOTION_PARENT_PAGE_ID", "마케팅", "Marketing",
     '["Journal of Marketing", "Journal of Marketing Research", "Journal of Consumer Research", "Marketing Science", "Quantitative Marketing and Economics"]',
     '["0022-2429", "1547-7185", "0022-2437", "1547-7193", "0093-5301", "1537-5277", "0732-2399", "1526-548X", "1570-7156", "1573-7155"]'),
     
    ("finance", "NOTION_FINANCE_PAGE_ID", "재무(Finance)", "Finance",
     '["The Journal of Finance", "Journal of Financial Economics", "The Review of Financial Studies", "Journal of Financial and Quantitative Analysis", "Review of Finance"]',
     '["0022-1082", "1540-6261", "0304-405X", "0893-9454", "1465-7368", "0022-1090", "1756-6916", "1572-3097", "1573-692X"]'),
     
    ("accounting", "NOTION_ACCOUNTING_PAGE_ID", "회계(Accounting)", "Accounting",
     '["The Accounting Review", "Journal of Accounting Research", "Journal of Accounting and Economics", "Contemporary Accounting Research", "Review of Accounting Studies"]',
     '["0001-4826", "1558-7967", "0021-8456", "1475-679X", "0165-4101", "0823-9150", "1911-3846", "1380-6653", "1573-7136"]')
]

for prefix, var, field, cap, jnames, jissns in mapping:
    code = template.format(PAGE_VAR=var, FIELD_NAME=field, PREFIX=prefix, CAP_FIELD=cap, TARGET_JOURNAL_NAMES=jnames, JOURNAL_ISSNS=jissns)
    with open(f"{prefix}_research_assistant.py", "w", encoding="utf-8") as f:
        f.write(code)
print("Files created.")
